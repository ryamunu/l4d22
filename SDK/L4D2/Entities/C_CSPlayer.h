...
public:
  ...
  virtual void CreateSplashes(bool unk1, bool unk2, bool unk3, Vector *unk4,
                              bool *unk5, bool *unk6) = 0;
  virtual void ResetObserverMode(void) = 0;
  virtual void ResetMaxSpeed(void) = 0;
  virtual void DoAnimationEvent(int unk1, int unk2) = 0;
  virtual void KickBack(float unk1, float unk2, float unk3, float unk4,
                        float unk5, float unk6, int unk7) = 0;
...
public:
  ...
  M_NETVAR(m_flProgressBarDuration, float, "CCSPlayer",
           "m_flProgressBarDuration");
  M_NETVAR(m_flProgressBarStartTime, float, "CCSPlayer",
